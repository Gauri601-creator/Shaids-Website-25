...
const Wrkshop = () => {
  ...
  const frame2024 = "https://ik.imagekit.io/igsnxowfs/events/2023-24/Beyond%20Bytes(workshop)/frame.jpg?updatedAt=1760585707012";
  ...
  const frame2025 = "https://ik.imagekit.io/igsnxowfs/events/2024-25/Beyond%20Bytes/img1.jpg?updatedAt=1761279848483";
    ...
    <>
      ...
      <div className="bg-bgGradient min-h-screen flex flex-col items-center p-6 md:p-10">
        ...
        <p className="text-white text-center font-Outfit max-w-3xl md:max-w-6xl mb-8">
          ...
          Department, this hands-on session dives into tech and beyond!
        </p>
          ...
          <section className="w-full flex flex-col items-center mb-12">
            <div className="w-full max-w-7xl flex flex-col sm:flex-row items-center gap-6 px-4 mb-8">
              <div className="w-full sm:w-[70%] aspect-square max-h-[38rem] rounded-xl border border-purple-400 shadow-lg overflow-hidden">
                <img src={frame2024} alt="Main 2024" className="w-full h-full object-cover" />
              </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 max-w-7xl w-full px-4" style={{ gridAutoRows: "200px" }}>
              {images2024.map((photo, i) => (
                <img key={i} src={photo} className={`object-cover w-full h-full rounded-xl ${i === 0 ? "col-span-2 row-span-2" : ""}`} />
              ))}
            </div>
          </section>
        )}
        ...
        {year === 2025 && (
          <section className="w-full flex flex-col items-center mb-20">
            <div className="w-full max-w-7xl flex flex-col sm:flex-row items-center gap-6 px-4 mb-8">
              <div className="w-full sm:w-[70%] aspect-square max-h-[38rem] rounded-xl border border-purple-400 shadow-lg overflow-hidden">
                <img src={frame2025} alt="Main 2025" className="w-full h-full object-cover" />
              </div>
